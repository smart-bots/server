 ...
 * Generated for Laravel 5.2.37 on 2016-06-18.
 *
...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function handle($input, $output = null){
            ...
            return \SmartBots\Console\Kernel::handle($input, $output);
        }
        ...
        public static function terminate($input, $status){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \SmartBots\Console\Kernel::terminate($input, $status);
        }
        ...
        public static function registerCommand($command){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \SmartBots\Console\Kernel::registerCommand($command);
        }
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \SmartBots\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \SmartBots\Console\Kernel::queue($command, $parameters);
        }
        ...
        public static function all(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \SmartBots\Console\Kernel::all();
        }
        ...
        public static function output(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \SmartBots\Console\Kernel::output();
        }
        ...
        public static function bootstrap(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \SmartBots\Console\Kernel::bootstrap();
        }
    ...
    class Is extends \Respect\Validation\Validator{
    ...
    class Sentry extends \Sentry\SentryLaravel\SentryFacade{
         ...
         * @static 
         */
        public static function getRelease($value){
            return \Raven_Client::getRelease($value);
        }
         ...
         * @static 
         */
        public static function getEnvironment($value){
            return \Raven_Client::getEnvironment($value);
        }
         ...
         * @static 
         */
        public static function getAppPath($value){
            return \Raven_Client::getAppPath($value);
        }
         ...
         * @static 
         */
        public static function getPrefixes($value){
            return \Raven_Client::getPrefixes($value);
        }
         ...
         * @static 
         */
        public static function getSendCallback($value){
            return \Raven_Client::getSendCallback($value);
        }
         ...
         * @static 
         */
        public static function getTransport($value){
            return \Raven_Client::getTransport($value);
        }
